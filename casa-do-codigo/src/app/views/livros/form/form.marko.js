...
function render(input, out, __component, component, state) {
  ...
  out.w("<div><label for=\"titulo\">Titulo:</label><input type=\"text\" id=\"titulo\" name=\"titulo\" value=\"" +
    ...
    "\" placeholder=\"coloque o titulo aqui\"></div><div><label for=\"preco\">Preço:</label><input type=\"text\" id=\"preco\" name=\"preco\" placeholder=\"150.25\" value=\"" +
    marko_escapeXmlAttr(data.livro.preco) +
    "\"></div><div><label for=\"descricao\">Descrição:</label><textarea rols=\"20\" cols=\"10\" id=\"descricao\" name=\"descricao\">" +
